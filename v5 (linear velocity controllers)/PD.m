function c = PD(Kp_phi, Kd_phi, Kp_theta, Kd_theta, Kp_psi, Kd_psi, Kp_x, Kd_x, Kp_y, Kd_y, Kp_z, Kd_z)
    ...
    c = @(state, thetadot) pd_controller(state, thetadot, Kp_phi, Kd_phi, Kp_theta, Kd_theta, Kp_psi, Kd_psi, Kp_x, Kd_x, Kp_y, Kd_y, Kp_z, Kd_z);

end



function [inputs,state] = pd_controller(state, thetadot, Kp_phi, Kd_phi, Kp_theta, Kd_theta, Kp_psi, Kd_psi, Kp_x, Kd_x, Kp_y, Kd_y, Kp_z, Kd_z)
