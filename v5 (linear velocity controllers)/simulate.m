...
%       thetadot=deg2rad(randi([-90,90],3,1));
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %For graph of desired orientation against time (to help with linear
    ...
    result = struct('x',xout,'theta',thetaout,'vel',xdotout,'angvel',thetadotout,'t',times, 'dt',dt,'input',inputout,'phides',phi_desout,'thetades',theta_desout,'errors',errors,'thrust',thrust);  
